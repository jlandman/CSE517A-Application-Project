...
for i in xrange(numCV):
    ...
    for j in xrange(10):
        ...
        pca2Clf = SGDClassifier(loss='log', penalty='l2', alpha=pca_alpha, learning_rate='optimal', max_iter=1000, tol=1e-3)
        ...
        pca3Clf = SGDClassifier(loss='log', penalty='l2', alpha=pca_alpha, learning_rate='optimal', max_iter=1000, tol=1e-3)
        ...
        lrClf = SGDClassifier(loss='log', penalty='l2', alpha=lr_alpha, learning_rate='optimal', max_iter=1000, tol=1e-3)
